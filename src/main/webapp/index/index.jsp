		...
		<div class="main">
			...
			<div class="team">
				...
				<dl>
					...
					<dd class="a1"><a href="teacherCenter.jsp">董教员 </a> <img src="${basePath}/index/images/ico_1.gif"/><img src="${basePath}/index/images/ico_2.gif"/><img src="${basePath}/index/images/ico_3.gif"/></dd>
				...
				<dl>
					...
					<dd class="a1"><a href="#">董教员 </a> <img src="images/ico_1.gif"/><img src="${basePath}/index/images/ico_2.gif"/><img src="${basePath}/index/images/ico_3.gif"/></dd>
					<dd class="a2">初中语数英</dd>
					<dd class="a2">美术特长教学</dd>
					<dd class="a3">自报价：25元/小时</dd>
